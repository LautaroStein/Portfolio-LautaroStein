...
function MyApp({ Component, pageProps }) {
  ...
  <Head>
    ...
    <link rel="icon" href={`/${asPath === "/" ? "Logo.png" : asPath === "/trabajos" ? "Logo-1.png" : "Logo-2.png"}`} />
  </Head>
  <main className='main-total' style={{background:`${asPath === "/" ? "#f4f9fc" : asPath === "/trabajos" ? "#FFF7F7" : null}`}}>
    <div className={`loader-real ${loader && "loader-off"}`} style={{background:`${asPath === "/" ? "#AADCEC" : asPath === "/trabajos" ? "#FCC5D3" : "#9BDABE"}`}}>
